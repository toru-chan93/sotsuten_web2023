...
function init() {
  ...
  scene.background = new THREE.Color(0xffffff); // 0xff0000
  ...
  const material = new THREE.MeshBasicMaterial({ color: 0xffffff }); // 0xff0000
  ...
  // 環境光源
  const ambientLight = new THREE.AmbientLight(0xed8787); // 0xaa3333
  ...
  document
    .querySelector(".book-contents__webgl-container")
